...
def main() -> int:
    ...
    parser.add_argument(
        "--client-identity",
        default=_env("ELKE27_CLIENT_IDENTITY", "elk-client"),
        help="Client identity string",
    )
    ...
    session = Session(cfg, client_identity=args.client_identity, link_key_hex=args.link_key_hex)
