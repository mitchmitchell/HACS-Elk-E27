...
def test_zone_get_configured_paging_merge_accumulates_blocks():
    ...
    blocks = [
        PagedBlock(block_id=1, payload={"block_id": 1, "block_count": 4, "zones": list(range(1, 17))}),
        PagedBlock(block_id=2, payload={"block_id": 2, "block_count": 4, "zones": list(range(17, 33))}),
        PagedBlock(block_id=3, payload={"block_id": 3, "block_count": 4, "zones": list(range(33, 49))}),
